...
HTML = """
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                ...
                <div class="winner-info"><div class="winner-name">Prabir Saha</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Dwijen Jotdar</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Dalia Dutta</div></div>
              </div>
            </div>
          </div>
          ...
          <!-- 12 to 18 Boys -->
          <div class="category-card">
            <h3 class="category-title">12 TO 18 BOYS</h3>
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Keya Ghosh</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Amit Chowdhury</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-2">2nd</div>
                <div class="winner-info"><div class="winner-name">Haripada Das</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Ramjiban Brahmachari</div></div>
              </div>
            </div>
          </div>
...
with open('results-4th-national-yogasana-sports-championship.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('results-4th-national-yogasana-sports-championship.html', 'w', encoding='utf-8') as f:
    f.write(new_content)
