...
HTML = """
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                ...
                <div class="winner-info"><div class="winner-name">Sumita Goswami</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                ...
                <div class="winner-info"><div class="winner-name">Subrata Paul</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Somnath Saha</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Pranati Mukherjee</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Maya Ghosh</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Mahadeb Dey</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Lalita Polley</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
...
with open('results-8th-national-yogasana-sports-championship.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('results-8th-national-yogasana-sports-championship.html', 'w', encoding='utf-8') as f:
    f.write(new_content)
