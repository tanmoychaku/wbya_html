...
HTML = """
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                ...
                <div class="winner-info"><div class="winner-name">Priyanka Dutta</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Mohuya Pramanick</div></div>
              </div>
              <div class="winner-item">
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Sangita Bhowmick</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              ...
              <div class="winner-item">
                <div class="winner-rank rank-3">3rd</div>
                <div class="winner-info"><div class="winner-name">Pampa Ghosh</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="category-card">
            ...
            <div class="winners-list">
              <div class="winner-item">
                <div class="winner-rank rank-1">1st</div>
                <div class="winner-info"><div class="winner-name">Soma Nandi</div></div>
              </div>
              <div class="winner-item">
                <div class="winner-rank rank-2">2nd</div>
...
with open('results-25th-national-yogasana-sports-championship.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('results-25th-national-yogasana-sports-championship.html', 'w', encoding='utf-8') as f:
    f.write(new_content)
